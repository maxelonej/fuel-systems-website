...
const languagesArray = {
  ru: {
    ...
    "strategy-description-1":
      "1. Стать бесспорным лидером на рынке топливных баков.",
    "strategy-description-2":
      "2. Обеспечить целевые экономические показатели для среднесрочного развития.",
    "strategy-description-3":
      "3. Принять обязательства по Качеству и Удовлетворенности потребителя в стремлении к совершенству во всех сферах деятельности.",
    "strategy-description-4":
      "4. Стать отраслевым эталоном корпоративной социальной ответственности: быть безопаснее, чтобы не было несчастных случаев быть более разнообразным, к полу, возрасту, культуре и этническому разнообразию на всех уровнях иерархии и во всех географических регионах.",

    "production-description":
      "Безопасные и качественные пластиковые топливные системы для автомобилей, а также производство локальных компонентов для них.",

    "clients-title": "Клиенты",

    "clients-description-1":
      "Нашими клиентами являются крупнейшие автопроизводители в России.",
    "clients-description-2":
      "Каждый 2ой автомобиль в стране оснащен нашим баком.",
    "clients-description-3":
      "Компания являлась поставщиком практически всех автомобильных производителей в России, таких как Тойота, Ниссан, Рено, Хёндэ, Форд.",

    "safety-description":
      "Мы ставим цели: 1. Достигнуть создания безаварийной и свободной от риска рабочей среды путём применения риск-ориентированного подхода для разработки превентивных мер и продвижения поведения в соответствии с 6 Обязательными Правилами по безопасности. 2. Улучшать рабочие условия, в стадиях разработки и серийного производства в соответствии с принципами эргономики. 3. Обеспечить гендерное равенство и увеличении числа женщин на руководящих позициях путём подбора и поддержки женщин за счет индивидуальных планов развития.",
    ...
    "ecology-description":
      "Мы бережно относимся к окружающей среде и полностью осознаем свою ответственность за то, чтобы свести к минимуму потенциальные последствия нашего воздействия на окружающую среду.",
    "ecology-link": "Экологическая политика",
    "ecology-link-description": "pdf, 132 Кб",

    "ecology-content-title": "Экология в цифрах",
    "ecology-content":
      "Мы предоставим данные: кол-во отходов передано на переработу, тем самым мы сохранили жизнь деревьям",
    ...
    "dsk-description-2":
      "Продукцией ДИПО являются пластиковые топливные системы автомобилей (топливные баки) для крупнейших автомобильных концернов, собирающих свои автомобили в России. На данный момент у ДИПО имеются 3 производственные площадки: в г. Тольятти (на территории ООО «ДСК») и пгт Ставрово. В данный момент ДИПО является лидирующим поставщиком топливных систем для автомобилестроения в России с нулевым показателем PPM брака у Потребителя.",
  ...
  en: {
    ...
    "strategy-description-1":
      "1. Become the undisputed leader in the fuel tank market.",
    "strategy-description-2":
      "2. Provide targeted economic indicators for medium-term development.",
    "strategy-description-3":
      "3. Commit to Quality and Customer Satisfaction in striving for excellence in all fields of activity.",
    "strategy-description-4":
      "4. To become an industry benchmark for corporate social responsibility: to be safer so that there are no accidents to be more diverse, by gender, age, culture and ethnic diversity at all levels of the hierarchy and in all geographical regions.",

    "production-description":
      "Safe and high-quality plastic fuel systems for cars, as well as the production of local components for them.",

    "clients-title": "Clients",

    "clients-description-1":
      "Our clients are the largest automakers in Russia.",
    "clients-description-2":
      "Every 2nd car in the country is equipped with our tank.",
    "clients-description-3":
      "The company was a supplier of almost all automobile manufacturers in Russia, such as Toyota, Nissan, Renault, Hyundai, Ford.",

    "safety-description":
      "We set goals: 1. To achieve the creation of an accident-free and risk-free working environment by applying a risk-based approach to develop preventive measures and promote behavior in accordance with the 6 Mandatory Safety Rules. 2. To improve the working conditions in the stages of development and mass production in accordance with the principles of ergonomics. 3. Ensure gender equality and increase the number of women in leadership positions by selecting and supporting women through individual development plans.",
    ...
    "ecology-description":
      "We take care of the environment and are fully aware of our responsibility to minimize the potential consequences of our environmental impact.",
    "ecology-link": "Environmental Policy of DIPO",
    "ecology-link-description": "pdf, 132 Kb",

    "ecology-content-title": "Ecology in numbers",
    "ecology-content":
      "We will provide data: the amount of waste was transferred for recycling, thereby we saved the life of trees",
